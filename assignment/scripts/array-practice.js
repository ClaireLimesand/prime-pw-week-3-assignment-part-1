...
let foods = ['curry', 'pho', 'banana bread', 'carbonara'];
...
foods.push('bbq');
console.log('Added a food to end,', foods);
...
console.log('The foods are now', foods);
...
foods.unshift('boba tea');
console.log(`Added a food to beginning: ${foods}` );
